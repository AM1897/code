...
function newGuess(){
   ...
   let data = verifyGuess(random, input)
    document.getElementById('guess-output').innerHTML = data[1]
    counter()
}
...
function counter(){
    ...
    document.getElementById('guess-output-counter').innerHTML = String (tries)
    tries++
}
